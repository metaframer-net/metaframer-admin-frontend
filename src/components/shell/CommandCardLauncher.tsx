...
export function CommandCardLauncher() {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="dock-command-center top-16 flex max-h-[calc(100dvh-5rem)] w-[calc(100%-2rem)] -translate-x-1/2 translate-y-0 origin-top flex-col gap-0 overflow-hidden rounded-3xl p-0 duration-[var(--duration-slow)] data-[state=closed]:zoom-out-100 data-[state=open]:zoom-in-100 data-[state=closed]:slide-out-to-top-12 data-[state=open]:slide-in-from-top-12 sm:max-w-2xl">
